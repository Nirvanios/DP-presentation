...
\begin{frame}{Základní vlastnosti}
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{center}
                \animategraphics[loop, autoplay, width=0.7\linewidth]{14}{img/video6/video6-}{0}{290}
            \end{center}
        \end{column}
    \end{columns}
...
\begin{frame}\frametitle{Výsledek}
    \animategraphics[loop, autoplay, width=0.5\linewidth]{14}{img/video6/video6-}{0}{290}
\end{frame}
